...
// solidity ^0.8.25 OPT 5000

/// @custom:security-contact info@scolcoin.com
/// @Dev: scolcoin@gmail.com
/***********************************************************
Scolcoin (SCOL) cryptocurrency create your own POA network
************************************************************/   
// Copyright (c) 2018-2023 Scolcoin (SCOL) Blockchain https://explorer.scolcoin.com/
// Copyright (c) 2023-2024 Scolcoin (SCOL) token Native SRC-20 

/*--------------------------------------------------------------- @dev
 * SCOLCOIN 2.0 Token hash SRC-20 https://explorer.scolcoin.com/address/0xf25bFda0E59E9f946eA85Df4B9D52d298a3a7E81/
 * POA network Scolcoin Wei Chain!
*/

/* < Block Genesis Token >
 - Total Supply: 80.000.000 SCOL token
 - Initial Supply: 1 SCOL Token
 + Coin support:   1 SCOL (token native blockchain)

 Change:
 1:1 Scolcoin Native of the SCOL wei chain network is changed to SCOL Token of the Binance BSC network
...
// File: contracts/scolcoinnat.sol
...
contract ScolcoinSCOLNative is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("Scolcoin (SCOL) Native", "SCOL")
        Ownable(initialOwner)
        ERC20Permit("Scolcoin (SCOL) Native")
    {
